        ...
        builder: (context, snapshot) => Container(
          ...
          child: Column(
            children: [
              ...
              SliderTheme(
                data: SliderTheme.of(context).copyWith(
                  activeTrackColor: TColors.primary,  // Active track color
                  inactiveTrackColor: TColors.primary.withOpacity(0.5),  // Inactive track color
                  thumbColor: Colors.grey,  // Thumb color
                  overlayColor: TColors.primary.withOpacity(0.2),  // Thumb overlay color when pressed
                  valueIndicatorColor: Colors.grey,  // Value indicator color (if shown)
                ),
                child: Slider(
                  divisions: divisions,
                  min: min,
